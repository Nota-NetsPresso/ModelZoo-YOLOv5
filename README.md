...
```bash
#Single GPU
python train.py --netspresso --data coco.yaml --epochs 300 --weights model_compressed.pt --batch-size 128 --device 0

#Multi GPU
python -m torch.distributed.run --nproc_per_node 2 train.py --netspresso --batch 64 --data coco.yaml --weights model_compressed.pt --device 0,1
```
...
| [YOLOv5n_rz](https://github.com/Nota-NetsPresso/yolov5_nota/blob/master/models/yolov5n_rz.pt)              | 640                   | 28.1                 | 46.4              | -                          | -                           | -                             | 1.8               | 4.6                  |
| [YOLOv5s](https://github.com/ultralytics/yolov5/releases/download/v7.0/yolov5s.pt)              | 640                   | 37.4                 | 56.8              | 98                           | 6.4                           | 0.9                            | 7.2                | 16.5                   |
| [YOLOv5s_rz](https://github.com/Nota-NetsPresso/yolov5_nota/blob/master/models/yolov5s_rz.pt)              | 640                   | 36.9                | 56.4              | -                           | -                          | -                            | 7.2                | 16.7  
| [YOLOv5m](https://github.com/ultralytics/yolov5/releases/download/v7.0/yolov5m.pt)              | 640                   | 45.4                 | 64.1              | 224                          | 8.2                           | 1.7                            | 21.2               | 49.0                   |
| [YOLOv5m_rz](https://github.com/Nota-NetsPresso/yolov5_nota/blob/master/models/yolov5m_rz.pt)              | 640                   | 44.8                 | 63.5             | -                          | -                           | -                             | 21.1               | 49.3                  |
| [YOLOv5l](https://github.com/ultralytics/yolov5/releases/download/v7.0/yolov5l.pt)              | 640                   | 49.0                 | 67.3              | 430                          | 10.1                          | 2.7                            | 46.5               | 109.1                  |
| [YOLOv5l_rz](https://github.com/Nota-NetsPresso/yolov5_nota/blob/master/models/yolov5l_rz.pt)              | 640                   | 48.3                 | 66.5              | -                          | -                           | -                             | 46.5              | 109.5                   |
| [YOLOv5x](https://github.com/ultralytics/yolov5/releases/download/v7.0/yolov5x.pt)              | 640                   | 50.7                 | 68.9              | 766                          | 12.1                          | 4.8                            | 86.7               | 205.7                  |
|                                                                                                                                                                                  |                       |                      |                   |                              |   
| [YOLO-fastest](https://github.com/Nota-NetsPresso/yolov5_nota/blob/master/models/yolov5-fastest.pt)              | 640                   | 15.1                 | 27.7              | -                          | -                          | -                            | 0.35               | 1.5                  |
|                            |                                |                    |                        |
